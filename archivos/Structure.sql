...
CREATE TABLE IF NOT EXISTS `cpg`.`experiencia_usada` (
  ...
  `experiencia_id_experiencia` INT NOT NULL,
  `fecha_uso_experiencia` DATETIME NOT NULL,
  INDEX `fk_experiencia_usada_experiencia1_idx` (`experiencia_id_experiencia` ASC) VISIBLE,
  INDEX `fk_experiencia_usada_user1_idx` (`user_id_user` ASC) VISIBLE,
  PRIMARY KEY (`user_id_user`, `experiencia_id_experiencia`),
...
CREATE TABLE IF NOT EXISTS `cpg`.`item` (
  ...
  `updatedAt` TIMESTAMP NULL,
  PRIMARY KEY (`id_item`),
  INDEX `fk_item_experiencia1_idx` (`experiencia_id_experiencia` ASC) VISIBLE,
